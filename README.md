...
The "default" environment will be used for running most scripts, while "gen" will be used for generating training data (trajectories). More information on that follows. If coming from the first step, get out of robust_physics_constrained_nn with ``cd ..``.
```
